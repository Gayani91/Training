...
object ScalaFun {
  //Static varaibles
  val fileContents = Source.fromFile("/home/ayoobm/Downloads/testScala/data/airports.text").getLines.toList
  ...
  def main(args: Array[String]): Unit = {
    println(groupByCountry())

  }

  //Group airports by country
  def groupByCountry(): Int ={
